...
const mdsUtilsMesaure = {
    _measurementOptions : L.extend({
        showOnHover:  false,
        minPixelDistance: 30,
        showDistances: true,
        showArea: true,
    ...
    // see LICENSE.md.
     ringArea : function ringArea(coords) {
        ...
        if (coordsLength > 2) {
            ...
            area = area * mdsUtilsMesaure.RADIUS * mdsUtilsMesaure.RADIUS / 2;
        }
     ...
     circleArea : function circleArea(d) {
        let rho = d / mdsUtilsMesaure.RADIUS;
        return 2 * Math.PI * mdsUtilsMesaure.RADIUS * mdsUtilsMesaure.RADIUS * (1 - Math.cos(rho));
    },
    mdsGetRotation: function(map, ll1, ll2) {
        var p1 = map.project(ll1),
            p2 = map.project(ll2);
...
export default mdsUtilsMesaure;