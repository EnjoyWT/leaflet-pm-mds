...
//   .setView([31.99, 118.71], 18);
// L.tileLayer("http://t{s}.tianditu.gov.cn/DataServer?T=cva_w&x={x}&y={y}&l={z}&tk=583a5ba8766602fb9802a4aa5bf0b40e", {
//       subdomains: ["0", "1", "2", "3", "4", "5", "6", "7"],
//       //zoomOffset: 1
//   }).addTo(map2);
//   let myLayer1 = L.tileLayer("http://t{s}.tianditu.gov.cn/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=583a5ba8766602fb9802a4aa5bf0b40e", {
//     subdomains: ["0", "1", "2", "3", "4", "5", "6", "7"],
//     //zoomOffset: 1
//     }).addTo(map2);
...
// map2.on("pm:mdsradiuschaneged",function (params) {
  
// })


var map = L.map('example2').setView([31.99, 118.71], 18);
let myLayer1 = L.tileLayer("http://t{s}.tianditu.gov.cn/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=583a5ba8766602fb9802a4aa5bf0b40e", {
                subdomains: ["0", "1", "2", "3", "4", "5", "6", "7"],
                //zoomOffset: 1
                }).addTo(map);
...
//   position: 'topleft',
// });
map.pm.enableDraw("Line", { showMeasurements: true });
